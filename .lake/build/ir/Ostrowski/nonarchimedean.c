...
// Module: Ostrowski.nonarchimedean
// Imports: Init Ostrowski.mul_ring_norm_rat Mathlib.NumberTheory.Padics.PadicNorm Mathlib.Order.Filter.Basic Mathlib.Analysis.SpecialFunctions.Log.Base Mathlib.Analysis.Normed.Ring.Seminorm Mathlib.Data.Nat.Digits
#include <lean/lean.h>
...
lean_object* initialize_Ostrowski_mul__ring__norm__rat(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Ostrowski_nonarchimedean(uint8_t builtin, lean_object* w) {
lean_object * res;
...
lean_dec_ref(res);
res = initialize_Ostrowski_mul__ring__norm__rat(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
